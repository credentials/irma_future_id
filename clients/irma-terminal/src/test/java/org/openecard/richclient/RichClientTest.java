...
//            InputStream manifestStream = FileUtils.resolveResourceAsStream(RichClientTest.class, "RichClientTest.java");
	    
//	    if (manifestStream == null) {
//	        System.out.println("imposible cargar recurso");
//		return;
//	    }
    ...
    @Test
    public void nothing() {
        System.out.println("IRMA-terminal TEST");
    }

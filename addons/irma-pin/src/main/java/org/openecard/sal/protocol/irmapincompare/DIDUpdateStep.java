...
import org.openecard.sal.protocol.irmapincompare.anytype.IRMAPINCompareDIDUpdateDataType;
...
public class DIDUpdateStep implements ProtocolStep<DIDUpdate, DIDUpdateResponse> {
	...
	try {
	    ...
	    IRMAPINCompareDIDUpdateDataType pinCompare = new IRMAPINCompareDIDUpdateDataType(request.getDIDUpdateData());

...
import org.openecard.sal.protocol.irmapincompare.anytype.IRMAPINCompareDIDAuthenticateOutputType;
...
public class DIDAuthenticateStep implements ProtocolStep<DIDAuthenticate, DIDAuthenticateResponse> {
	...
	try {
	    ...
	    IRMAPINCompareDIDAuthenticateInputType pinCompareInput = new IRMAPINCompareDIDAuthenticateInputType(request.getAuthenticationProtocolData());
	    IRMAPINCompareDIDAuthenticateOutputType pinCompareOutput = pinCompareInput.getOutputType();
	    ...
	    IRMAPINCompareMarkerType pinCompareMarker = new IRMAPINCompareMarkerType(didStructure.getDIDMarker());

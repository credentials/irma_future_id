 ...
 */
public class IRMAPINCompareDIDAuthenticateOutputType {
     ...
     */
    public IRMAPINCompareDIDAuthenticateOutputType(DIDAuthenticationDataType data) throws ParserConfigurationException {
     ...
     */
    protected IRMAPINCompareDIDAuthenticateOutputType(AuthDataMap authMap) {

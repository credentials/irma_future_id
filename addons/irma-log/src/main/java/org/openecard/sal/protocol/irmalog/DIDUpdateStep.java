...
//import org.openecard.sal.protocol.irmalog.anytype.IRMALOGDIDUpdateDataType;
...
public class DIDUpdateStep implements ProtocolStep<DIDUpdate, DIDUpdateResponse> {
	...
	try {/*
	    ...
	    IRMALOGDIDUpdateDataType pinCompare = new IRMALOGDIDUpdateDataType(request.getDIDUpdateData());

 ...
 */
public class IRMALOGDIDAuthenticateInputType {
     ...
     */
    public IRMALOGDIDAuthenticateInputType(DIDAuthenticationDataType data) throws ParserConfigurationException {
     ...
     */
    public IRMALOGDIDAuthenticateOutputType getOutputType() {
	return new IRMALOGDIDAuthenticateOutputType(authMap);
    }

 ...
 */
public class IRMASTATUSDIDAuthenticateInputType {
     ...
     */
    public IRMASTATUSDIDAuthenticateInputType(DIDAuthenticationDataType data) throws ParserConfigurationException {
     ...
     */
    public IRMASTATUSDIDAuthenticateOutputType getOutputType() {
	return new IRMASTATUSDIDAuthenticateOutputType(authMap);
    }

...
//import org.openecard.sal.protocol.irmastatus.anytype.IRMASTATUSDIDUpdateDataType;
...
public class DIDUpdateStep implements ProtocolStep<DIDUpdate, DIDUpdateResponse> {
	...
	try {/*
	    ...
	    IRMASTATUSDIDUpdateDataType pinCompare = new IRMASTATUSDIDUpdateDataType(request.getDIDUpdateData());

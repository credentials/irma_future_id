...
//import org.openecard.sal.protocol.irmaprover.anytype.IRMAPROVERDIDUpdateDataType;
...
public class DIDUpdateStep implements ProtocolStep<DIDUpdate, DIDUpdateResponse> {
	...
	try {/*
	    ...
	    IRMAPROVERDIDUpdateDataType pinCompare = new IRMAPROVERDIDUpdateDataType(request.getDIDUpdateData());

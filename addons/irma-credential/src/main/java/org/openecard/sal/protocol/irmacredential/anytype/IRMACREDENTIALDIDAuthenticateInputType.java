 ...
 */
public class IRMACREDENTIALDIDAuthenticateInputType {
     ...
     */
    public IRMACREDENTIALDIDAuthenticateInputType(DIDAuthenticationDataType data) throws ParserConfigurationException {
     ...
     */
    public IRMACREDENTIALDIDAuthenticateOutputType getOutputType() {
	return new IRMACREDENTIALDIDAuthenticateOutputType(authMap);
    }

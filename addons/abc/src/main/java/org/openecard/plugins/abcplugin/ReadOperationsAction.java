...
package org.openecard.plugins.abcplugin;
...
import org.openecard.plugins.abcplugin.gui.ReadOperationsDialog;
 ...
 */
public class ReadOperationsAction extends AbstractPINAction {

    private static final Logger logger = LoggerFactory.getLogger(ReadOperationsAction.class);
	...
	try {
	    ...
	    ReadOperationsDialog uc = new ReadOperationsDialog(gui, dispatcher, cHandle, credentials);
	    uc.show();

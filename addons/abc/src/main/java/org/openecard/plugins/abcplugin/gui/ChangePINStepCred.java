 ...
 */
public class ChangePINStepCred extends Step {
    ...
    private static final String PINSTEP_NEWPIN = "Administration PIN";
    private static final String PINSTEP_OLDPIN = "New credential PIN";
     ...
     * @param verifyFailed 
     */
    public ChangePINStepCred(String id, String title, boolean capturePin, int retryCounter, boolean enteredWrong,
	...
	if (!capturePin) {
	    ...
	    i1.setText("Please enter your desired credential PIN and your administration PIN.");

	    PasswordField oldPIN = new PasswordField(OLD_PIN_FIELD);
	    oldPIN.setDescription("Administration PIN");
	    getInputInfoUnits().add(oldPIN);

	    PasswordField newPIN = new PasswordField(NEW_PIN_FIELD);
	    newPIN.setDescription("New credential PIN");

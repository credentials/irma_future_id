...
import org.openecard.plugins.abcplugin.gui.ChangeAdminPinDialog;
 ...
 */
public class ChangeAdminPinAction extends AbstractPINAction {

    private static final Logger logger = LoggerFactory.getLogger(ChangeAdminPinAction.class);
	...
	try {
	    ...
	    ChangeAdminPinDialog uc = new ChangeAdminPinDialog(gui, dispatcher, cHandle);
	    uc.show();

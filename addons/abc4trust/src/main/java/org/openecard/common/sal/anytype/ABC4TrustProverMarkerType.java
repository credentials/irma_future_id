 ...
 */
public class ABC4TrustProverMarkerType {

    private String policy = null;
    private String protocol;

    public ABC4TrustProverMarkerType(iso.std.iso_iec._24727.tech.schema.DIDAbstractMarkerType didAbstractMarkerType) {
	if(!(didAbstractMarkerType instanceof iso.std.iso_iec._24727.tech.schema.ABC4TrustProverMarkerType)){

 ...
 */
public class ChangePINDialogCred {
    ...
    /**
     * Creates a new instance of ChangePINDialogCred.
     * 
     ...
     */
    public ChangePINDialogCred(UserConsent gui, Dispatcher dispatcher, ConnectionHandleType conHandle,
	...
	Step changePINStep = new ChangePINStepCred("pin-entry", title, capturePin, retryCounter, false, false);

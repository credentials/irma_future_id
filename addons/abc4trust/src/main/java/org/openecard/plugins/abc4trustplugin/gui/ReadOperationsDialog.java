...
import org.openecard.plugins.abc4trustplugin.IdemixLogEntry;
 ...
 */
public class ReadOperationsDialog {

    private final I18n lang = I18n.getTranslation("abc4trustplugin");
    private static final Logger logger = LoggerFactory.getLogger(ReadOperationsDialog.class);
     ...
     */
    public ReadOperationsDialog(UserConsent gui, Dispatcher dispatcher, ConnectionHandleType conHandle, Vector<Integer> credentials) {
	this.gui = gui;
